...
```{r, echo=FALSE, fig.width=4,fig.height=4, fig.align='center', fig.cap="Multivariate QQ plot for pre covid data"}
library(MVN)
mvn_pre <- mvn(pre_covid_mano, mvnTest="hz", multivariatePlot = "qq") #no
```

```{r, echo=FALSE, fig.width=4,fig.height=4, fig.align='center', fig.cap="Multivariate QQ plot for post covid data"}
mvn_post <- mvn(post_covid_mano, mvnTest="hz" , multivariatePlot = "qq") #no
```


```{r, echo=FALSE, fig.width=4,fig.height=4, fig.align='center', fig.cap="Multivariate QQ plot for all data"}
...
```{r, echo=FALSE, fig.width=4,fig.height=4, fig.align='center', fig.cap="Biplot of variables for pre covid data's PCA when scaled by standard deviation"}
